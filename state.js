(function (root) {
  ...
  const State = {
    ...
    /* 스와이프로 화면에서 치운 종목 (표시 전용, 휘발성).
       localStorage에 저장하지 않으므로 앱을 다시 열면 모두 복원된다.
       신호 기록·학습 데이터·거래 기록과는 완전히 무관하며, 백그라운드 감시와
       자가학습은 이 목록과 상관없이 모든 종목에 대해 계속 동작한다. */
    dismissed: {},    // symbol -> true
